...
class Elegant_Pink_Featured_Post extends WP_Widget {
	...
	public function widget( $args, $instance ) {
        ...
        if( $qry->have_posts() ){
            ...
            ?>
                ...
                <?php } ?>
                <p><?php echo elegant_pink_excerpt( get_the_content(), $excerpt_char, '.', false, true );?></p>
	...
	public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'excerpt_char' ); ?>"><?php esc_html_e( 'Excerpt Character', 'elegant-pink' ); ?></label> 
