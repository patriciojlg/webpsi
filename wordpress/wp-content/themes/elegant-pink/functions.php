...
function elegant_pink_scripts() {
    ...
    wp_enqueue_style( 'elegant-pink-style', get_stylesheet_uri(), '', '1.1' );
    ...
    wp_register_script( 'elegant-pink-custom-js', get_template_directory_uri() . '/js/custom.js', array('jquery'), '20151222', true );
	wp_register_script( 'elegant-pink-ajax', get_template_directory_uri() . '/js/ajax.js', array('jquery'), '20160225', true );
