...
if ( $tags ) {
	...
	if ( $my_query->have_posts() ) {
		echo '<div class="related-posts row"><div class="related-posts-content col-md-12"><div class="related-posts-title"><h3>' . __( 'Related posts', 'first-mag' ) . '</h3></div><ul class="row">';
		while ( $my_query->have_posts() ) {
			$my_query->the_post();
			?> 
			<li class="rpost col-sm-6 hover-style">
				<?php if ( has_post_thumbnail() ) : ?>                               
					<div class="featured-thumbnail"><?php the_post_thumbnail( 'first-mag-home' ); ?></div>                                                           
				<?php else : ?>
