...
function apc_init(){
  ...
  fancySelect();
  // repeater edit
  //bindOn('click','.at-re-toggle',function() {$(this).prev().toggleClass('cn-edit-hide-element');});
  ...
  bindOn('click','[data-dismiss="alert"]',function(){$(this).parent().remove();});
    ...
    //Enrique Crespo Added
    $('.cn-image-radio-option img').click(function(){
          $(this).parent().removeClass('checked unchecked').siblings().removeClass('checked').addClass('unchecked').end().addClass('checked');
      });
